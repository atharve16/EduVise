...
const AttributionWrapper = styled.div`
  text-align: center;
  padding: 20px;
  background: linear-gradient(135deg, rgba(83, 148, 222, 0.1), rgba(83, 148, 222, 0.05));
  border-radius: 15px;
  ...
  &::before {
    ...
    width: 100%;
    height: 100%;
    background: linear-gradient(90deg, transparent, rgba(83, 148, 222, 0.2), transparent);
